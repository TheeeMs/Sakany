...
@Service
public class CancelCommandHandler implements CommandHandler<CancelCommand, Void> {

    private final MaintenanceRequestRepository repository;
    private final ApplicationEventPublisher eventPublisher;

    public CancelCommandHandler(MaintenanceRequestRepository repository, ApplicationEventPublisher eventPublisher) {
